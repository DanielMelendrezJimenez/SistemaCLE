 ...
 * @author wltgm
 */
public class editar_Calificaciones_View_Srv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (encodedParametros != null) {
            ...
            id_calificacion = parametros.get("CalificacionId");
                    ...
                    switch (rol) {
                        case "COORDINADOR":
                            if (id_calificacion == null) {
                                ...
                                try {
                                    Calificaciones_DAO.encontrarCalificacion(VariablesSistema.USERNAME_BD, VariablesSistema.PASSWORD_BD, Integer.parseInt(id_calificacion), respuesta);
                                    request.setAttribute("calificacion", respuesta.getResponseObject());

                                    redirectView(request, response, "/views/Calificaciones/Paginas/editar_Calificacion_View.jsp");

                                } catch (NumberFormatException e) {
                                    respuesta.setMensaje("El campo requerido CalificacionId no es válido debe ser entero");
                                }
                            }
                            break;
                        case "FACILITADOR":

 ...
 * @author wltgm
 */
public class guardar_Calificaciones_Srv extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String id_alumno = request.getParameter("inpAlumnoId");
        String id_grupo = request.getParameter("inpGrupoId");
        ...
        param.setId_alumno(Integer.parseInt(id_alumno));
        param.setId_grupo(Integer.parseInt(id_grupo));
        ...
        Calificaciones_DAO.setCalificacion(VariablesSistema.USERNAME_BD, VariablesSistema.PASSWORD_BD, param, respuesta);

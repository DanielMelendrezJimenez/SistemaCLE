 ...
 */
public class mostrar_Inscritos_View_Srv extends HttpServlet {
        @Override
                ...
                if (usuario != null) {
                    ...
                    switch (rol) {
                        ...
                        case "SUPERVISOR":
                            ...
                            Alumnos_DAO.getAlumnosGruposList(VariablesSistema.USERNAME_BD, VariablesSistema.PASSWORD_BD, respuesta);
                            request.setAttribute("AlumnosGruposList", respuesta.getResponseObject());

                            redirectView(request, response, "/views/Alumnos/Paginas/mostrar_Inscritos_View.jsp");

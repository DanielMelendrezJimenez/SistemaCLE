 ...
 * @author wltgm
 */
public class mostrarAlumnos_View_Srv extends HttpServlet {
                ...
                if (usuario != null) {
                    ...
                    switch (rol) {
                        case "COORDINADOR":
                            ...
                            Alumnos_DAO.mostrarAlumnos(VariablesSistema.USERNAME_BD, VariablesSistema.PASSWORD_BD, respuesta);
                            request.setAttribute("AlumnosGruposList", respuesta.getResponseObject());

                            redirectView(request, response, "/views/Alumnos/Paginas/mostrar_Alumnos_View.jsp");

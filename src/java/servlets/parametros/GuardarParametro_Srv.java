 ...
 */
public class GuardarParametro_Srv extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Parametros_DAO.setParametro(VariablesSistema.USERNAME_BD, VariablesSistema.PASSWORD_BD, param, respuesta);

 ...
 * @author wltgm
 */
public class consultarGrupos_View_Srv extends HttpServlet {
                        ...
                        case "COORDINADOR":
                            ...
                            if (respuesta.getResponseObject() == null) {
                                ...
                                if (d.after(fecha.getFecha_inicio()) && d.before(fecha.getFecha_fin())) {
                                    ...
                                    redirectView(request, response, "/views/Grupos/Paginas/Consultar_grupos_Coordi_View.jsp");
                                } else {
                                    redirectView(request, response, "/views/templates/errores/error404.jsp");
                                }
                        ...
                        case "SUPERVISOR":
                            ...
                            if (respuesta.getResponseObject() == null) {
                                ...
                                if (d.after(fecha.getFecha_inicio()) && d.before(fecha.getFecha_fin())) {
                                    ...
                                    redirectView(request, response, "/views/Grupos/Paginas/Consultar_grupos_View.jsp");
                                } else {
                                    redirectView(request, response, "/views/templates/errores/error404.jsp");
                                }

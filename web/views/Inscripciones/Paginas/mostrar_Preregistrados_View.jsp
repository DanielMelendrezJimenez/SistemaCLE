...
<html>
    ...
    <body style="overflow: auto" class="cuerpo"> 
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12" align="right">
                                ...
                                --%>
                                <button id="btnEditar" name="btnEditar" class= "btn btn-editar btn-sm"><i class= "fa fa-pencil"></i>&nbsp;Completar</button>
        ...
        <script src="../../js/jsgenerados/tabla_preinscritos.js" ></script>           

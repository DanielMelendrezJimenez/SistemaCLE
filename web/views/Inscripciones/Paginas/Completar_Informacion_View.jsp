<%-- 
    Document   : Completar_Informacion_View
    Created on : Jul 24, 2024, 1:57:12 PM
    Author     : wltgm
--%>
...
<html>
    ...
    <body>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class=" panel-body">
                                <form  id="formCompletarInfo" 
                                    ...
                                    <input type="hidden" class="form-control"  name="inpAluGrupo" id="inpAluGrupo" value="<c:out value="${id_alu_grupo}"/>">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input disabled type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getNombre()}"/>" id="inNombre" name="inNombre" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input disabled type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getAp_pat()}"/>" id="inpAp_pat" name="inpAp_pat" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input disabled type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getAp_mat()}"/>" id="inpAp_mat" name="inpAp_mat" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input disabled type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getGenero()}"/>" id="inpGenero" name="inpGenero" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input disabled type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getNo_control()}"/>" id="inpNo_control" name="inpNo_control" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input  type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getCorreo()}"/>" id="inpCorreo" name="inpCorreo" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small">Tipo Alumno*</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <span class="fa fa-users"></span>
                                                    </span>
                                                    <select id="inTipoAlumno" name="inTipoAlumno" class="form-control input-sm data" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="number" maxlength="10" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getTelefono()}"/>" id="inpTelefono" name="inpTelefono" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select id="inCarrera" name="inCarrera" class="form-control input-sm data" required>
                                                        <option disabled hidden selected value="-1">Seleccione</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="number" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="" id="inFolio" name="inFolio" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="number" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="" id="inpReferencia" name="inpReferencia" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="number" maxlength="5" class="form-control dataForm input-sm data" placeholder="" value="" id="inpCantidad" name="inpCantidad" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                    </div>  
        ...
        <script  src="../../js/jsgenerados/init_completar_info.js"></script>
    </body>
</html>

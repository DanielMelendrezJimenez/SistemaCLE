...
<html>
    ...
    <body>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="panel panel-default">
                            ...
                            <div class=" panel-body">
                                <form  id="formEditFacilitador" 
                                       name="formEditFacilitador" 
                                       role="form"  
                                       class="needs-validation ">
                                    <input type="hidden" class="form-control"  name="inpFacilitadorId" id="inpFacilitadorId" value="<c:out value="${facilitador.getId()}"/>">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="${facilitador.getNombre()}" id="inNombre" name="inNombre" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="${facilitador.getAp_pat()}" id="inAp_pat" name="inAp_pat" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="${facilitador.getAp_mat()}" id="inAp_mat" name="inAp_mat" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="text" class="form-control dataForm input-sm data" placeholder="" value="${facilitador.getNo_control()}" id="inNo_control" name="inNo_control" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="password" class="form-control dataForm input-sm data" placeholder="" value="${facilitador.getContrasena()}" id="inPassword" name="inPassword" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="email" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="${facilitador.getCorreo()}" id="inCorreo" name="inCorreo" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                    </div>
        ...
        <script  src="../../js/jsgenerados/edit_facilitador.js"></script>
    </body>
</html>

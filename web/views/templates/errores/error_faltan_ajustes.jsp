<!--
    Document   : error220
    Created on : 29/04/2023, 04:21:54 PM
...
<html>
    <head>
        ...
        <title>Faltan ajustes importantes</title>
    </head>
        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h1 class="panel-title">Alerta de configuración</h1>
                </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-md-12 text-justify" >
                                <span id="errorPagina">No puede navegar por esta página. Faltan ajustes importantes.</span>
                            </div>

...
<html>
    ...
    <body style="overflow: auto" class="cuerpo"> 
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12" align="right">
                                ...
                                <button id="btnDetalles" name="btnDetalles" class= "btn btn-primary btn-sm"><i class= "fa fa-plus-square"></i>&nbsp;Consultar</button>
                                <button id="btnEditar" name="btnEditar" class= "btn btn-editar btn-sm"><i class= "fa fa-pencil"></i>&nbsp;Agregar</button>
        ...
        <script src="../../js/jsgenerados/tabla_grupos_facilitador.js" ></script>           

<%-- 
    Document   : editar_Alumno_View
    Created on : Aug 6, 2024, 1:33:12 PM
    Author     : wltgm
--%>
...
<html>
    ...
    <body>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class=" panel-body">
                                <form  id="formEditarAlumno" 
                                    ...
                                    <input type="hidden" class="form-control"  name="inpAlumnoId" id="inpAlumnoId" value="<c:out value="${alumno.getId()}"/>">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getNombre()}"/>" id="inpNombre" name="inpNombre" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getAp_pat()}"/>" id="inpAp_pat" name="inpAp_pat" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getAp_mat()}"/>" id="inpAp_mat" name="inpAp_mat" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select id="inpGenero" name="inpGenero" class="form-control input-sm data" required>
                                                        <option disabled hidden selected value="-1">Seleccione</option>
                                                        <option value="MASCULINO" <c:if test="${alumno.getGenero() == 'MASCULINO'}">selected</c:if>>MASCULINO</option>
                                                        <option value="FEMENINO" <c:if test="${alumno.getGenero() == 'FEMENINO'}">selected</c:if>>FEMENINO</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                    <input  type="email" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getCorreo()}"/>" id="inpCorreo" name="inpCorreo" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select id="inpTipoAlumno" name="inpTipoAlumno" class="form-control input-sm data" required>
                                                        <option disabled hidden selected value="-1">Seleccione</option>
                                                        <option value="INTERNO" <c:if test="${alumno.getTipo_alumno() == 'INTERNO'}">selected</c:if>>INTERNO</option>
                                                        <option value="EXTERNO" <c:if test="${alumno.getTipo_alumno() == 'EXTERNO'}">selected</c:if>>EXTERNO</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                                        <input type="text" class="form-control dataForm input-sm data" placeholder="" value="<c:out value="${alumno.getTelefono()}"/>" id="inpTelefono" name="inpTelefono" required="">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select id="inCarrera" name="inCarrera" class="form-control input-sm data" required>
                                                        <option disabled hidden selected value="-1">Seleccione</option>
                                                        <option value="Tics" <c:if test="${alumno.getCarrera() == 'Tics'}">selected</c:if>>Tics</option>
                                                        <option value="Sistemas" <c:if test="${alumno.getCarrera() == 'Sistemas'}">selected</c:if>>Sistemas</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script  src="../../js/jsgenerados/edit_alumno.js"></script>
    </body>
</html>

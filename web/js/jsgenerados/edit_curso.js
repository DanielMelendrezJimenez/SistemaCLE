    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.status === 0)
            {
                ...
                mensajeError("Error", "El curso ya existe");
            } else {
            ...
            if (data.status === 0) {
                bootbox.dialog({
                    ...
                    message: '<div class="row" style="text-align: justify">' +
                            '<div class="col-md-12">' +
                            '<h3 class="panel-title"></h3>' +
                            '<p>' + "El curso fue editado exitosamente." + '</p>' +
                            '</div>' +
                            '</div>',
                    buttons: {
                        main: {

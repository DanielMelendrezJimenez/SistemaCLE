<!--
    Document   : error404
    Created on : 19/10/2016, 04:21:54 PM
    Author     : Miguel Colin
-->
...
<html>
    <head>
        ...
        <title>Dirección web incorrecta</title>
    </head>
        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h1 class="panel-title">Página no encontrada - Dirección web incorrecta</h1>
                </div>
                ...
                <div class="panel-body" id="panel-principal">
                    ...
                    <div class="col-md-4">
                        <div class="col-md-12" id="ocultarLinea">-</div>
                        <div class="col-md-12" id="ocultarLinea">-</div>
                        <span><img src="/Generico-ITT/img/error_liga.png" id="errorImagen"></span>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-md-10" >
                                <span id="errorPrincipal">¡Cuidado!</span>
                            </div>


                            <div class="col-md-12 text-justify" >
                                <span id="errorPagina">No está ingresando a una aplicación válida, la dirección web no es correcta.</span>
                            </div>
	                  
                            <div class="col-md-12" >
                                <br><span id="errorContacto"></span>
                            </div>
							
                            <div class="col-md-12" >
                                <br><span id="errorContacto">Verifique la dirección, por favor.</span>
                            </div>

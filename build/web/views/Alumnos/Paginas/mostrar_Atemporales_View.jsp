<%-- 
    Document   : mostrarPreregistrados_View
    Created on : Jul 23, 2024, 6:28:23 PM
    Author     : wltgm
--%>
...
<html>
    ...
    <body style="overflow: auto" class="cuerpo"> 
                    ...
                    <div class="panel-body">
                            ...
                            <table id="tabla" name="tabla" class="table table-striped table-bordered tablesorter no-footer dtr-inline dataTable table_margen"  style="width: 100%;">
                                ...
                                <thead>
                                    <tr class="info itt-catalogos-search-row">
                                        ...
                                        <th class="bordeTd"><input id="tabla-colSearch6"  class="form-control" type="text" placeholder="Buscar:" style="width: 100%" data-index="7"></th>
                                ...
                                <tbody>
                                    <c:forEach var="elemento" items="${AlumnosGruposList}">
                        ...
                        <div class="row">
                            <div class="col-md-12" align="right">
                                ...
                                <button id="btnEliminar" name="btnEliminar" class= "btn btn-editar btn-sm"><i class= "fa fa-pencil"></i>&nbsp;Validar</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="../../js/jsgenerados/tabla_atemporales.js" ></script>           

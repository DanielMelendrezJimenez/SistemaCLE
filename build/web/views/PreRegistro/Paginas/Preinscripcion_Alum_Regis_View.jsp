<%-- 
    Document   : Preinscripcion_Alum_Regis_View
    Created on : Jun 29, 2024, 8:52:57 PM
...
<html>
    ...
    <body>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="panel panel-default">
                            ...
                            <div class=" panel-body">
                                <form  id="formAddPreRegistroExistente" 
                                       name="formAddPreRegistroExistente" 
                                       role="form"  
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" maxlength="30" class="form-control dataForm input-sm data" placeholder="" value="" id="inNo_Control" name="inNo_Control">                                    
                                                </div>
                                            </div>                                  
                                        </div>
                                        <div class="col-md-4">
        ...
        <script  src="../../js/jsgenerados/init_preregistro_existente.js"></script>
    </body>
</html>

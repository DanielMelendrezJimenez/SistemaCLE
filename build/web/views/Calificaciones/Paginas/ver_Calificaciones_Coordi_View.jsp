<%-- 
    Document   : ver_Calificaciones_Coordi_View
    Created on : Aug 9, 2024, 4:28:05 PM
    Author     : wltgm
--%>
...
<html>
    ...
    <body style="overflow: auto" class="cuerpo"> 
                    ...
                    <div class="panel-body">
                            ...
                            <table id="tabla" name="tabla" class="table table-striped table-bordered tablesorter no-footer dtr-inline dataTable table_margen"  style="width: 100%;">
                                ...
                                <thead>
                                    <!--                                    <tr class="info itt-catalogos-search-row">
                                                                            <th class="bordeTd"><input id="tabla-colSearch1"  class="form-control" type="text" placeholder="Buscar:" style="width: 30%" data-index="1"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch2"  class="form-control" type="text" placeholder="Buscar:" style="width: 20%" data-index="2"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch3"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="3"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch4"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="4"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch5"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="5"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch6"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="6"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch7"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="7"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch8"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="8"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch9"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="9"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch10"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="10"></th>
                                                                            <th class="bordeTd"><input id="tabla-colSearch11"  class="form-control" type="text" placeholder="Buscar:" style="width: 10%" data-index="11"></th>
                                                                        </tr>-->
                                    <tr class="info">
                                        <th>Alumno</th>
                                        <th>Num. Control</th>
                                ...
                                <tbody>
                                    <c:forEach var="elemento" items="${CalificacionesGruposList}">
                                        <tr id="${elemento.getId()}">
                                            <td>${elemento.getAlumno()}</td>
                                            <td>${elemento.getNo_control()}</td>
                                            <td>${elemento.getCorreo()}</td>
                                            <td>${elemento.getListening()}</td>
                                            <td>${elemento.getReading()}</td>
                                            <td>${elemento.getWriting()}</td>
                                            <td>${elemento.getSpeaking()}</td>
                                            <td>${elemento.getPromedio()}</td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <div class="row">
                            <div class="col-md-12" align="right">
                                ...
                                <button id="btnDetalles" name="btnDetalles" class= "btn btn-primary btn-sm"><i class= "fa fa-plus-square"></i>&nbsp;Correo</button>
        ...
        <script src="../../js/jsgenerados/tabla_calificaciones.js" ></script>           
